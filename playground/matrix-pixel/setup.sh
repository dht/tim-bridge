...
echo "  3) Set your address in .env (recommended):"
echo "       - macOS: IDOTMATRIX_ADDRESS_DARWIN=<UUID>"
echo "       - Pi/Linux: IDOTMATRIX_ADDRESS_LINUX=AA:BB:CC:DD:EE:FF"
echo "  4) Run: ./.venv/bin/python blue.py"
echo ""
echo "If BLE scanning fails, reboot and/or try running with sudo once:"
echo "  sudo IDOTMATRIX_ADDRESS_LINUX=\"AA:BB:CC:DD:EE:FF\" ./.venv/bin/python blue.py"
