...
- macOS: run `./setup-mac.sh` (it will install `idotmatrix` from PyPI unless `./python3-idotmatrix-library` contains a valid `pyproject.toml` or `setup.py`)
...
until 15:15
- one speaking head with mouth shapes and sound
